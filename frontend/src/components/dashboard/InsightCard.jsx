    ...
    <GlassCard className="p-4 group hover:shadow-soft-lg hover:-translate-y-0.5 transition-all duration-300">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <h4 className="font-semibold text-[14px] text-ink-900 leading-snug">{tr(insight.title, locale)}</h4>
          <p className="text-[12.5px] text-ink-500 leading-snug mt-1">{tr(insight.summary, locale)}</p>
